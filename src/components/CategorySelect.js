            ...
            <div className='card m-3' style={{border: 'none'}}>
              <div className='test-hover'>
                ...
                <Link
                  to='/brakes'
                  >
                  <img style={{height: '13rem',  width: '100%'}} src={ require(`./../images/colony-brethren-brake-set-black.jpg`)} alt="Grips" title="Grips"/>
                </Link>
              </div>
            </div>
            ...
            <div className='card m-3' style={{border: 'none'}}>
              <div className='test-hover'>
                ...
                <Link
                  to='/wheels'
                  >
                  <img style={{height: '13rem',  width: '100%'}} src={ require(`./../images/colony-pintour-freecoaster-wheel-black.jpg`)} alt="Grips" title="Grips"/>
                </Link>
              </div>
            </div>
